!(function (e, a) {
  ...
  (n.fn.appear = function (r, e) {
    var d = n.extend({ data: void 0, one: !0, accX: 0, accY: 0 }, e);
            ...
            (a = function () {
              ...
              u.is(":visible")
                ? ((e = s.scrollLeft()),
                  ...
                  e <= r + o + p &&
                  r <= e + f + p
                    ? u.appeared || u.trigger("appear", d.data)
                    : (u.appeared = !1))
                : (u.appeared = !1);
            }),
            (e = function () {
              ...
              (u.appeared = !0),
                d.one &&
                  (s.unbind("scroll", a),
                  0 <= (e = n.inArray(a, n.fn.appear.checks)) &&
                    n.fn.appear.checks.splice(e, 1)),
                r.apply(this, arguments);
            }),
            d.one ? u.one("appear", d.data, e) : u.bind("appear", d.data, e),
            s.scroll(a),
            n.fn.appear.checks.push(a),
            a())
          : u.trigger("appear", d.data);
    });
  }),
